 ...
 * Clean, scalable SVG chess pieces
 */
...
function WhiteKing({ size = 45 }: { size: number }) {
  return (
...
function BlackKing({ size = 45 }: { size: number }) {
  return (
    <svg viewBox="0 0 45 45" width={size} height={size}>
      <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
function WhiteQueen({ size = 45 }: { size: number }) {
  return (
    <svg viewBox="0 0 45 45" width={size} height={size}>
...
function BlackQueen({ size = 45 }: { size: number }) {
  return (
    <svg viewBox="0 0 45 45" width={size} height={size}>
      <g fill="#000" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M9 26c0 2 1.5 2 2.5 4 1 1.5 1 1 .5 3.5-1.5 1-1.5 2.5-1.5 2.5-1.5 1.5.5 2.5.5 2.5 6.5 1 16.5 1 23 0 0 0 1.5-1 0-2.5 0 0 .5-1.5-1-2.5-.5-2.5-.5-2 .5-3.5 1-2 2.5-2 2.5-4-8.5-1.5-18.5-1.5-27 0z" strokeLinecap="butt"/>
        <path d="M11 38.5a35 35 1 0 0 23 0" fill="none" stroke="#000"/>
...
function WhiteRook({ size = 45 }: { size: number }) {
  return (
    <svg viewBox="0 0 45 45" width={size} height={size}>
      <g fill="#fff" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M14 29.5v2.5h17v-2.5" strokeLinecap="butt"/>
        <path d="M14 16.5L11 14h23l-3 2.5" fill="#fff" strokeLinecap="butt" strokeLinejoin="miter"/>
      </g>
    </svg>
  );
}

function BlackRook({ size = 45 }: { size: number }) {
  return (
    <svg viewBox="0 0 45 45" width={size} height={size}>
      <g fill="#000" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M14 16.5L11 14h23l-3 2.5H14zM11 14V9h4v2h5V9h5v2h5V9h4v5H11z" strokeLinecap="butt" strokeLinejoin="miter"/>
...
function WhiteBishop({ size = 45 }: { size: number }) {
  return (
    <svg viewBox="0 0 45 45" width={size} height={size}>
      <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
function BlackBishop({ size = 45 }: { size: number }) {
  return (
    <svg viewBox="0 0 45 45" width={size} height={size}>
      <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
function WhiteKnight({ size = 45 }: { size: number }) {
  return (
    <svg viewBox="0 0 45 45" width={size} height={size}>
      <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
function BlackKnight({ size = 45 }: { size: number }) {
  return (
    <svg viewBox="0 0 45 45" width={size} height={size}>
      <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
function WhitePawn({ size = 45 }: { size: number }) {
  return (
    <svg viewBox="0 0 45 45" width={size} height={size}>
...
function BlackPawn({ size = 45 }: { size: number }) {
  return (
    <svg viewBox="0 0 45 45" width={size} height={size}>
...
const PIECE_COMPONENTS: Record<string, React.FC<{ size: number }>> = {
...
export default function PieceSVG({ type, color, size = 45 }: PieceSVGProps) {
